...
import 'package:musicproject2/Homepage.dart';
import 'package:musicproject2/test.dart';
...
class _MyHomePageState extends State<MyHomePage> {
  int _counter = 0;
void awsoefijd(){
  Navigator.push(context,MaterialPageRoute(builder: (context) => MyNextPage(title: 'awefrsd')));
}
